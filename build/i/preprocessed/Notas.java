...
public class Notas extends MIDlet implements CommandListener {
    ...
    public Displayable mostrarIngresoNotas(){
        ...
        txtEvaluacion = new TextField("Evaluacion:", "", 6, TextField.ANY);
        ...
        frmIngresoNotas.append(txtEvaluacion);
    ...
    private Alert mostrarNotaParcial(){
        altNotaCiclo = new Alert(materia + " - nota de ciclo", "Su nota de ciclo es: " + String.valueOf(notaParcial),null,AlertType.INFO);
    ...
    public void commandAction(Command c, Displayable d) {
        if(c.equals(cmdSalir)) {
            ...
            if(c.equals(cmdGuardar)){
                ...
                RegistroNotas.guardarNota(txtEvaluacion.getString(),txtPorcentaje.getString(),txtNota.getString());
